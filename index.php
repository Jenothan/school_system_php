...
<body class="bg-light select-none hide-scrollbar">
	<?php
	...
	<table class="w-full h-full">
		<tr style="height: 100%;">
			...
			<td style="width: 85%; height: 100%;">
				...
				<div class="fixed top-0 w-[85%] flex flex-row bg-[#2E4756] justify-between items-center px-4 py-3 z-50">
					...
					<a href="?page=create-form&section=<?php echo ucfirst($sec); ?>"
						...
						class="bg-[#FFBF00] px-6 py-3 text-center font-semibold text-black w-40 hover:bg-[#CB9800] rounded-[10px]">
				...
				<div class="overflow-auto hide-scrollbar bg-white p-2 pt-20">
					...
					if (file_exists($path)) {
						...
						echo "<div class='flex justify-center items-center'><h1 class='text-3xl text-red-600'>404 page not found</h1></div>";
					}
					?>
				</div>
